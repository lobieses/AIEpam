...
class UserRAG:
    ...
    async def __aenter__(self):
        ...
        print(f"тЖЧя╕П Creating embeddings and vectorstore for {len(documents)} documents...")
        self.vectorstore = await self._create_vectorstore_with_batching(documents, batch_size=100)
        print("тЬЕ Vectorstore is ready.")
        return self
        ...
        async with UserRAG(embeddings, llm_client) as rag:
            ...
            while True:
                ...
                try:
                    ...
                    print(f"тЭМ Error processing question: {e}")
