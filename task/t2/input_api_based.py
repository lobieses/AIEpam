...
## Examples:
- "Who is John?" тЖТ name: "John"
- "Find users with surname Smith" тЖТ surname: "Smith" 
- "Look for john@example.com" тЖТ email: "john@example.com"
- "Find John Smith" тЖТ name: "John", surname: "Smith"
- "I need user emails that filled with hiking" тЖТ No clear search parameters (return empty list)
...
#   - Values for search should be correct (тЬЕ John -> тЭМ Jonh)
#   - Is not so flexible
# Benefits are:
